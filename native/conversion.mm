...
// Platform-specific includes and definitions
    ...
    #define prnt(fmt, ...) __android_log_print(ANDROID_LOG_DEBUG, "conversion", fmt, ##__VA_ARGS__)
    #define prnt_err(fmt, ...) __android_log_print(ANDROID_LOG_ERROR, "conversion", fmt, ##__VA_ARGS__)
#else
    #include <stdio.h>
    // Logging macros for other platforms
    #define prnt(fmt, ...) printf("[conversion] " fmt "\n", ##__VA_ARGS__)
    #define prnt_err(fmt, ...) printf("[conversion error] " fmt "\n", ##__VA_ARGS__)
#endif
